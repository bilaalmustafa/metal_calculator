            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  Row(
                    children: [
                      ImageContainer(image: 'assets/icons/channel.png'),
                      SizedBox(width: 10),
                      Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                              ...
                              SizedBox(
                                ...
                                child: DropdownButtonFormField<String>(
                                  ...
                                  onChanged: (value) {
                                    setState(
                                      () {
                                        channelController.selectedMaterial =
                                            value!;
                                        steel = {
                                              "Steel": 7.85,
                                              "Aluminum": 2.73,
                                  ...
                                  onTap: () {
                                    showDialog(
                                      ...
                                      builder: (context) => AddMetalDialog(
                                        ...
                                        selectedUnitLength: channelController
                                            .selectedUnitLength,
                                        onUnitChanged: (value) {
                          ...
                          children: [
                            ...
                            isLengthWeight
                                ? customTextField2("Kg Price:",
                                    channelController.priceController)
                                : SizedBox(),
                            const SizedBox(height: 10),
                            Container(
                          ...
                          children: [
                            if (selectedValue1 == 'UPN')
                              DropdownButtonFormField<String>(
                                ...
                                items: upnItems.map<DropdownMenuItem<String>>(
                                    (String value) {
                                  return DropdownMenuItem<String>(
                                    value: value,
                                    child: Text(value),
                            ...
                            if (selectedValue1 == 'UPE')
                              DropdownButtonFormField<String>(
                                ...
                                items: upeItems.map<DropdownMenuItem<String>>(
                                    (String value) {
                                  return DropdownMenuItem<String>(
                                    value: value,
                                    child: Text(value),
                            ...
                            if (selectedValue1 == 'PFC BS 4-1-2005')
                              DropdownButtonFormField<String>(
                                ...
                                items: pfcItems.map<DropdownMenuItem<String>>(
                                    (String value) {
                                  return DropdownMenuItem<String>(
                                    value: value,
                                    child: Text(value),
                            ...
                            if (selectedValue1 == 'CH BS 4-1-1993')
                              DropdownButtonFormField<String>(
                                ...
                                items: chItems.map<DropdownMenuItem<String>>(
                                    (String value) {
                                  return DropdownMenuItem<String>(
                                    value: value,
                                    child: Text(value),
