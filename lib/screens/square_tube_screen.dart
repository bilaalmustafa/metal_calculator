            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  Row(
                    children: [
                      ImageContainer(image: 'assets/icons/square_tube.png'),
                      SizedBox(width: 10),
                      Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                                  ...
                                  onTap: () {
                                    showDialog(
                                      ...
                                      builder: (context) => AddMetalDialog(
                                        ...
                                        densityController: squareTubeController
                                            .densityController,
                                        selectedUnitLength: squareTubeController
                                            .selectedUnitLength,
                                        onUnitChanged: (value) {
                                          squareTubeController
                        ...
                        children: [
                          ...
                          isLengthWeight
                              ? customTextField2("Kg Price:",
                                  squareTubeController.priceController)
                              : SizedBox(),
